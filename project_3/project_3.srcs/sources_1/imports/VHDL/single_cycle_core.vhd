...
--modified
component unsign_sign_extend_4to16 is
...
component fowarding_unit is
    port (c_mem_data1 : in std_logic; --data1 = 1 when read from memory, data = 0 when read from alu (wreg 1)
          ...
          mem_wreg1 : in std_logic_vector(3 downto 0);
          wb_wreg1 : in std_logic_vector(3 downto 0);
          mem_wreg2 : in std_logic_vector(3 downto 0);
          wb_wreg2 : in std_logic_vector(3 downto 0);
          ...
          ex_rreg1 : in std_logic_vector(3 downto 0);
          ex_rreg2 : in std_logic_vector(3 downto 0);
...
component hazard_detection_unit is
    port (c_ex_data1 : in std_logic;
          ...
          id_rreg1 : in std_logic_vector(3 downto 0);
          id_rreg2 : in std_logic_vector(3 downto 0);
          ex_wreg1 : in std_logic_vector(3 downto 0); -- no need to check for reg2
          ex_wreg2 : in std_logic_vector(3 downto 0);
          mem_wreg1 : in std_logic_vector(3 downto 0);
...
signal if_pc_plus_1                : std_logic_vector(3 downto 0);
signal if_next_pc   : std_logic_vector(3 downto 0);
signal if_pc_plus_1_carry          : std_logic; -- not used
signal if_insn                 : std_logic_vector(15 downto 0);
---
---
...
-- datapath
signal id_pc_plus_1 : std_logic_vector(3 downto 0);
signal id_pc_plus_1_and_offset_carry : std_logic; -- not used
signal id_inst  : std_logic_vector(15 downto 0);
signal id_pc_plus_1_and_offset : std_logic_vector(3 downto 0);
signal id_extended_offset : std_logic_vector(15 downto 0);
signal id_wreg1: std_logic_vector(3 downto 0);
signal id_wreg2: std_logic_vector(3 downto 0);
...
signal ex_wreg1 : std_logic_vector(3 downto 0);
signal ex_wreg2 : std_logic_vector(3 downto 0);
...
signal mem_wreg1 : std_logic_vector(3 downto 0);
signal mem_wreg2 : std_logic_vector(3 downto 0);
...
signal wb_wreg1: std_logic_vector(3 downto 0);
signal wb_wdata1 : std_logic_vector(15 downto 0);
signal wb_wreg2: std_logic_vector(3 downto 0);
...
signal ex_read_reg1 : std_logic_vector(3 downto 0);
signal ex_read_reg2 : std_logic_vector(3 downto 0);
...
begin
    ...
    pc_plus_one_adder : adder_4b
    port map (src_a     =>  sig_one_4b,
              src_b     =>  if_curr_pc,
              sum       =>  if_pc_plus_1,
              carry_out =>  if_pc_plus_1_carry);
              
   pc_next_inst_mux : mux_2to1_4b
    port map(mux_select =>  c_if_branch_sel,
             data_a     =>  if_pc_plus_1,
             data_b     =>  id_pc_plus_1_and_offset,
             data_out   =>  if_next_pc);
             
    c_if_branch_sel <= (id_not_eq and c_id_branch_enable);         
    ...
    port map (c_ex_data1                => ex_control_bus2(1),
              ...
              id_rreg1                  => id_inst(11 downto 8),
              id_rreg2                  => id_inst(7 downto 4),
              ex_wreg1                  => ex_wreg1, -- no need to check for reg2
              ex_wreg2                  => ex_wreg2,
              mem_wreg1                 => mem_wreg1,
              opcode                    => id_inst(15 downto 12),
    ...
    pc_plus_1_and_offset_adder : adder_4b
    port map (src_a     =>  id_pc_plus_1,
              src_b     =>  id_inst(3 downto 0),
              sum       =>  id_pc_plus_1_and_offset,
              carry_out =>  id_pc_plus_1_and_offset_carry);

    
    unsign_sign_extend : unsign_sign_extend_4to16 
    port map ( data_in  => id_inst(3 downto 0),
               unsign_sel => c_id_extension,
               data_out => id_extended_offset);
    ctrl_unit : control_unit 
    port map ( opcode     => id_inst(15 downto 12),
               control_bus => id_control_bus);
   
    mux_write_reg1 : mux_2to1_4b 
    port map ( mux_select => c_id_wreg1_sel,
               data_a     => id_inst(7 downto 4),
               data_b     => id_inst(3 downto 0),
               data_out   => id_wreg1);
               
    id_wreg2 <= id_inst(7 downto 4);

    reg_file : register_file 
    port map ( reset           => reset, 
               clk             => clk,
               read_register_a => id_inst(11 downto 8),
               read_register_b => id_inst(7 downto 4),
    ...
    port map (c_mem_data1           => mem_control_bus2(1),
              ...
              wb_wdata1             => wb_wdata1,
              wb_wdata2             => wb_wdata2,
              ex_rreg1              => id_inst(11 downto 8),
              ex_rreg2              => id_inst(7 downto 4),
